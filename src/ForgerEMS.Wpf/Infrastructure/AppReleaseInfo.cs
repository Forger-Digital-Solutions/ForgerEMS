...
internal static class AppReleaseInfo
{
    ...
    public const string Version = "1.2.1-preview.1";

    /// <summary>Primary user-facing version line in the shell.</summary>
    public const string DisplayVersion = "ForgerEMS v1.2.1 Public Preview";

    /// <summary>Short footer / welcome subtitle (single line preferred).</summary>
    public const string ReleaseIdentifier =
        "ForgerEMS v1.2.1 Public Preview \u2014 technician USB toolkit, System Intelligence, Kyra (offline-first + beta gateway)";
