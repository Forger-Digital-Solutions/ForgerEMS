...
{
    public const string KyraGatewayUrl = "FORGEREMS_KYRA_GATEWAY_URL";
    public const string KyraGatewayBetaToken = "FORGEREMS_KYRA_GATEWAY_BETA_TOKEN";
    public const string KyraGatewayTimeoutSeconds = "FORGEREMS_KYRA_GATEWAY_TIMEOUT_SECONDS";
    public const string KyraGatewayDailyRequestLimit = "FORGEREMS_KYRA_GATEWAY_DAILY_REQUEST_LIMIT";
    public const string KyraGatewayShareSystemContext = "FORGEREMS_KYRA_GATEWAY_SHARE_SYSTEM_CONTEXT";
    ...
    public const string GitHubModelsDefaultModel = "FORGEREMS_GITHUB_MODELS_DEFAULT_MODEL";
    public const string GitHubModelsFastModel = "FORGEREMS_GITHUB_MODELS_FAST_MODEL";
    public const string GitHubModelsAltModel = "FORGEREMS_GITHUB_MODELS_ALT_MODEL";
    ...
    public const string UxHowToConfigure =
        ...
        $"- ForgerEMS Beta Gateway: {KyraGatewayUrl} and {KyraGatewayBetaToken} (gateway token only, not a provider API key)\n" +
        $"- Google Gemini: {Gemini}\n" +
        $"- Groq: {Groq}\n" +
        $"- OpenRouter: {OpenRouter}\n" +
        $"- Cerebras: {Cerebras}\n" +
        $"- Mistral: {Mistral}\n" +
        $"- GitHub Models: {GitHubModels} (optional models: {GitHubModelsDefaultModel}, {GitHubModelsFastModel}, {GitHubModelsAltModel})\n" +
