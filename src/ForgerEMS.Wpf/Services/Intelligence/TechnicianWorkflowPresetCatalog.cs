...
public static class TechnicianWorkflowPresetCatalog
{
    ...
    [
        ...
        Build(
            ...
            ["Run System Intelligence scan", "Review health score and key watch-outs", "Check RAM/storage/GPU/driver pressure indicators", "Validate with Task Manager during symptom reproduction"],
            ["System Intelligence", "Hardware X-Ray", "Kyra"],
        ...
        Build(
            ...
            ["System Intelligence", "Toolkit storage diagnostics tools"],
        ...
        Build(
            ...
            ["Run System Intelligence and Quick Read", "Review Flip Value and Best Use", "Confirm battery/security/storage confidence limits", "Document honest disclosures"],
            ["System Intelligence", "Kyra", "Export Summary"],
        ...
        Build(
            ...
            ["Run System Intelligence and diagnostics checklist", "Check storage and boot/security readiness", "Review startup/service signals", "Stage rescue toolkit media"],
            ["System Intelligence", "Diagnostics", "USB Builder toolkit"],
        ...
        Build(
            ...
            ["System Intelligence", "Diagnostics", "Kyra"],
