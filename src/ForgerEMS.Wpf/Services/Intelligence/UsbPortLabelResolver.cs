...
public static class UsbPortLabelResolver
{
        ...
        UsbPortLabelValidity validity)
    {
        return new UsbIntelligenceBenchmarkResult
        {
            ...
            VerifiedWriteMbps = source.VerifiedWriteMbps,
            VerifiedReadMbps = source.VerifiedReadMbps,
            RawReadMbps = source.RawReadMbps,
            IsReadCacheSuspected = source.IsReadCacheSuspected,
            ReadVerificationStatus = source.ReadVerificationStatus,
