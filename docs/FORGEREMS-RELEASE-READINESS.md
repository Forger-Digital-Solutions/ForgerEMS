...
## Current v1.2.4-preview.2 Preview Gate
...
1. `ForgerEMS-v1.2.4-preview.2.zip` is a portable app ZIP. After extraction,
...
.\tools\Validate-ForgerEMSRelease.ps1 -Version 1.2.4-preview.2 -ReleaseRoot .\release\current
```
...
not the current v1.2.4-preview.2 release gate.
