# ForgerEMS beta tester quickstart (Public Preview v1.2.4-preview.1)
...
Get **`ForgerEMS-v1.2.4-preview.1.zip`** when published. Optionally verify **`CHECKSUMS.sha256`** from the same release. Older `v1.1.12-rc.*` assets remain on prior GitHub tags for history only.
