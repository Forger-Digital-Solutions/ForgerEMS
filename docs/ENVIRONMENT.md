...
This file documents supported and reserved ForgerEMS environment variables for v1.2.0 Public Preview. Do not put real secrets in source files, screenshots, support emails, or issue reports. Use `.env.example` as a placeholder-only reference.
