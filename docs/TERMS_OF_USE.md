...
Terms version: `2026-07-02.v1.2.3-preview.1`
...
ForgerEMS is not a finished enterprise product, a magic automatic fixer, a complete replacement for OEM tools, a complete live sensor suite, a substitute for certified repair services, or legal, warranty, safety, compliance, medical, or financial advice.

## Your Responsibility

You are responsible for checking the correct device, backing up data before risky work, reviewing downloads and licenses, confirming vendor guidance, and validating any repair, driver, firmware, USB, benchmark, or support action before using it.
...
Do not use ForgerEMS for unauthorized access, password bypass on devices you do not own or administer, credential theft, malware, piracy, or other illegal activity.

## No Warranties

ForgerEMS is provided as-is and at your own risk. No production-ready, compliance-certified, attorney-reviewed, or guaranteed repair status is claimed.

## Changes

If the terms version changes, the app requires acceptance again before unlocking the main tools.
