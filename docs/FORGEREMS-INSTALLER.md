...
- App version: `1.2.4-preview.3`
- Installer artifact: `ForgerEMS-Setup-v1.2.4-preview.3.exe`
- Portable artifact: `ForgerEMS-v1.2.4-preview.3.zip`
...
```text
dist\installer\ForgerEMS-Setup-v1.2.4-preview.3.exe
```
...
Versioned distribution artifacts (for example `ForgerEMS-Setup-v1.2.4-preview.3.exe` and `ForgerEMS-v1.2.4-preview.3.zip`) should be attached to a GitHub Release for the matching tag, rather than committed under `release\vX.Y.Z\`.
