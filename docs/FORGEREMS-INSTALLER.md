...
- App version: `1.2.4-preview.2`
- Installer artifact: `ForgerEMS-Setup-v1.2.4-preview.2.exe`
- Portable artifact: `ForgerEMS-v1.2.4-preview.2.zip`
...
```text
dist\installer\ForgerEMS-Setup-v1.2.4-preview.2.exe
```
...
Versioned distribution artifacts (for example `ForgerEMS-Setup-v1.2.4-preview.2.exe` and `ForgerEMS-v1.2.4-preview.2.zip`) should be attached to a GitHub Release for the matching tag, rather than committed under `release\vX.Y.Z\`.
