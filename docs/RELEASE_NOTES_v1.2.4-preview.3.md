# ForgerEMS v1.2.4-preview.3 Release Notes

ForgerEMS `v1.2.4-preview.3` is a preview/pre-release build for Windows technicians.
...
- `ForgerEMS-v1.2.4-preview.3.zip` portable app ZIP
- `CHECKSUMS.sha256`
