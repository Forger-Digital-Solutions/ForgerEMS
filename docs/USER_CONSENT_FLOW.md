...
Both checkbox notices render as wrapped multi-line text inside the gate so they stay fully readable at 1366x768. The gate header shows the document revision date and the ForgerEMS version it applies to (`Document revision: 2026-07-05 · Applies to ForgerEMS v1.2.4-preview.3`).
