...
2. Find the version you were invited to test (current Public Preview example: **v1.2.1-preview.1**).  
3. Under **Assets**, download **one** of these ZIPs (same contents inside):
   - `ForgerEMS-v1.2.1-preview.1.zip` **or**
   - `ForgerEMS-Beta-v1.2.1-preview.1.zip`  
...
8. Open the extracted folder **`ForgerEMS-v1.2.1-preview.1`** (name matches the ZIP root for that tag).  
