...
2. Find the version you were invited to test (current Public Preview example: **v1.2.4-preview.4**).
...
8. Open the extracted folder **`ForgerEMS-v1.2.4-preview.4`** (name matches the ZIP root for that tag).
...
5) Extract the ZIP, open folder ForgerEMS-v1.2.4-preview.4, double-click START_HERE.bat.
