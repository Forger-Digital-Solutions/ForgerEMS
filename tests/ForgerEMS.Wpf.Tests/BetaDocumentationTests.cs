...
public sealed class BetaDocumentationTests
{
        ...
        foreach (var name in new[]
                 {
                     ...
                     "RELEASE_NOTES_v1.2.4-preview.3.md", "reports/FORGEREMS_V1_2_3_FULL_PROJECT_AUDIT.md"
                 })
        {
    ...
    public void Readme_MentionsCurrentBetaAndFaq()
    {
        ...
        Assert.Contains("1.2.4-preview.3", text, StringComparison.Ordinal);
    ...
    public void CurrentLegalDocs_ReferenceVersionPreviewAndConsentBoundaries()
    {
        ...
        var releaseNotes = File.ReadAllText(Path.Combine(RepoRoot, "docs", "RELEASE_NOTES_v1.2.4-preview.3.md"));

        Assert.Contains("2026-07-05.v1.2.4-preview.3", terms, StringComparison.Ordinal);
        ...
        Assert.Contains("ForgerEMS-v1.2.4-preview.3.zip", releaseNotes, StringComparison.Ordinal);
    }
