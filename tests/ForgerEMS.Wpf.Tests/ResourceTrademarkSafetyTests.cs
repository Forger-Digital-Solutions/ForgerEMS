...
public sealed class ResourceTrademarkSafetyTests
{
    ...
    public void DocsAndInAppLegal_ContainIndependenceDisclaimer()
    {
        ...
        Assert.Contains(IndependenceDisclaimer, InfoDocumentTexts.BuildAbout("1.2.4-preview.4", "ForgerEMS v1.2.4 Public Preview", "frontend", "backend"), StringComparison.Ordinal);
